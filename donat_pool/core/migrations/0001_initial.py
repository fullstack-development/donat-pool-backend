    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('settings', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='categories', related_query_name='categories', to='core.sitesettings')),
            ],
            options={
